...
// in jnote/test/domain/usecases/update_task_test.dart.
...
import 'package:jnote/src/domain/repositories/task_repository.dart' as _i3;
...
class MockTaskRepository extends _i1.Mock implements _i3.TaskRepository {
  ...
  @override
  _i4.Future<List<_i2.Task>> getAll() => (super.noSuchMethod(
        Invocation.method(
          #getAll,
          [],
        ),
  ...
  @override
  _i4.Future<_i2.Task> getById(int? id) => (super.noSuchMethod(
        Invocation.method(
          #getById,
          [id],
        ),
